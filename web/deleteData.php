...
<body>
    ...
    <main class="delete">
    <h2>Deleting From Membership</h2>
    ...
    <article class="delete">
        <img src="image/warning.png"><br>
        <h3>You need to be aware that, if you delete your email address,<br> all your information stored in this website will be removed as well.</h3>
