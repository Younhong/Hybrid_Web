  ...
  <body>
    ...
    <main class="insert">
      ...
      <form action="insertResult.php" method="post">
        ...
        <br>(Type of Wild Animal you are interested in.)
        <br><br>
    ...
    <article class="insert">
      ...
      <h3> What benefit you will get from joining our membership?</h3>
      <h6>You can communicate with people who have same interest with you within the city you are living now.</h6>
